...
//@interface weatherappweek1Object : NSObject
//@end

@interface weatherappweek1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[weatherappweek1Object class]])
		{
			for (NSString *key in [[(weatherappweek1Object*)o modules] allKeys])
			{
