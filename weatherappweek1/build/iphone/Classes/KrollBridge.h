...
@interface weatherappweek1Object : KrollCoverageObject {
#else
@interface weatherappweek1Object : KrollObject {
#endif
@private
...
extern NSString * weatherappweek1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	weatherappweek1Object *_weatherappweek1;
    KrollObject* console;
	BOOL shutdown;
