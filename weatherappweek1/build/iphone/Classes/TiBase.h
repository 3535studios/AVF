...
// in simulator we redefine to format for weatherappweek1 Developer console
...
{\
	NSString * exceptionName = [@"org.weatherappweek1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.weatherappweek1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIweatherappweek1NativeItemNone = -1, 
	UIweatherappweek1NativeItemSpinner = -2,
	UIweatherappweek1NativeItemProgressBar = -3,
	
	UIweatherappweek1NativeItemSlider = -4,
	UIweatherappweek1NativeItemSwitch = -5,
	UIweatherappweek1NativeItemMultiButton = -6,
	UIweatherappweek1NativeItemSegmented = -7,
	
	UIweatherappweek1NativeItemTextView = -8,
	UIweatherappweek1NativeItemTextField = -9,
	UIweatherappweek1NativeItemSearchBar = -10,
	
	UIweatherappweek1NativeItemPicker = -11,
	UIweatherappweek1NativeItemDatePicker = -12,
	
	UIweatherappweek1NativeItemInfoLight = -13,
	UIweatherappweek1NativeItemInfoDark = -14,
	
	UIweatherappweek1NativeItemDisclosure = -15,
	
	UIweatherappweek1NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all weatherappweek1 instances of
