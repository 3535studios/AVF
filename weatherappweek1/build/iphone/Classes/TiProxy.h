...
//Rare exceptions to indicate a bug in the _weatherappweek1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for weatherappweek1 proxies.
 */
