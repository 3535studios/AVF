...
//@interface walmartstorelocatorweek3Object : NSObject
//@end

@interface walmartstorelocatorweek3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[walmartstorelocatorweek3Object class]])
		{
			for (NSString *key in [[(walmartstorelocatorweek3Object*)o modules] allKeys])
			{
