...
/**
 The base class for all walmartstorelocatorweek3 modules
 */
...
/**
 walmartstorelocatorweek3 Platform calls this method on startup.
 */
-(void)startup;

/**
 walmartstorelocatorweek3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 walmartstorelocatorweek3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 walmartstorelocatorweek3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 walmartstorelocatorweek3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
