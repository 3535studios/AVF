...
/**
 Base class for all walmartstorelocatorweek4 views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the walmartstorelocatorweek4 view hierarchy (such as wrapped iOS UIViews) was touched.
