 ...
 * to send analytic data that can be viewed on the walmartstorelocatorweek4 Dashboard.
 *
 * For information on getting started with walmartstorelocatorweek4 Platform Services,
