...
//Rare exceptions to indicate a bug in the _walmartstorelocatorweek4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for walmartstorelocatorweek4 proxies.
 */
