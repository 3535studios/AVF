...
//@interface walmartstorelocatorweek4Object : NSObject
//@end

@interface walmartstorelocatorweek4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[walmartstorelocatorweek4Object class]])
		{
			for (NSString *key in [[(walmartstorelocatorweek4Object*)o modules] allKeys])
			{
