...
@interface walmartstorelocatorweek4Object : KrollCoverageObject {
#else
@interface walmartstorelocatorweek4Object : KrollObject {
#endif
@private
...
extern NSString * walmartstorelocatorweek4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	walmartstorelocatorweek4Object *_walmartstorelocatorweek4;
    KrollObject* console;
	BOOL shutdown;
