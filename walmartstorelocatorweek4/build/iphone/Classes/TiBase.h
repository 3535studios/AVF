...
// in simulator we redefine to format for walmartstorelocatorweek4 Developer console
...
{\
	NSString * exceptionName = [@"org.walmartstorelocatorweek4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.walmartstorelocatorweek4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIwalmartstorelocatorweek4NativeItemNone = -1, 
	UIwalmartstorelocatorweek4NativeItemSpinner = -2,
	UIwalmartstorelocatorweek4NativeItemProgressBar = -3,
	
	UIwalmartstorelocatorweek4NativeItemSlider = -4,
	UIwalmartstorelocatorweek4NativeItemSwitch = -5,
	UIwalmartstorelocatorweek4NativeItemMultiButton = -6,
	UIwalmartstorelocatorweek4NativeItemSegmented = -7,
	
	UIwalmartstorelocatorweek4NativeItemTextView = -8,
	UIwalmartstorelocatorweek4NativeItemTextField = -9,
	UIwalmartstorelocatorweek4NativeItemSearchBar = -10,
	
	UIwalmartstorelocatorweek4NativeItemPicker = -11,
	UIwalmartstorelocatorweek4NativeItemDatePicker = -12,
	
	UIwalmartstorelocatorweek4NativeItemInfoLight = -13,
	UIwalmartstorelocatorweek4NativeItemInfoDark = -14,
	
	UIwalmartstorelocatorweek4NativeItemDisclosure = -15,
	
	UIwalmartstorelocatorweek4NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all walmartstorelocatorweek4 instances of
