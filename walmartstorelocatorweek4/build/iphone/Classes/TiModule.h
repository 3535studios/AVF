...
/**
 The base class for all walmartstorelocatorweek4 modules
 */
...
/**
 walmartstorelocatorweek4 Platform calls this method on startup.
 */
-(void)startup;

/**
 walmartstorelocatorweek4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 walmartstorelocatorweek4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 walmartstorelocatorweek4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 walmartstorelocatorweek4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
