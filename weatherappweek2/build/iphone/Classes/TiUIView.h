...
/**
 Base class for all weatherappweek2 views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the weatherappweek2 view hierarchy (such as wrapped iOS UIViews) was touched.
