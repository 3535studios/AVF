...
/**
 The base class for all weatherappweek2 modules
 */
...
/**
 weatherappweek2 Platform calls this method on startup.
 */
-(void)startup;

/**
 weatherappweek2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 weatherappweek2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 weatherappweek2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 weatherappweek2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
