...
//@interface weatherappweek2Object : NSObject
//@end

@interface weatherappweek2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[weatherappweek2Object class]])
		{
			for (NSString *key in [[(weatherappweek2Object*)o modules] allKeys])
			{
