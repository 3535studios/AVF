...
//Rare exceptions to indicate a bug in the _weatherappweek2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for weatherappweek2 proxies.
 */
