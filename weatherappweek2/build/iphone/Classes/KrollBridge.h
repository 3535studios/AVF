...
@interface weatherappweek2Object : KrollCoverageObject {
#else
@interface weatherappweek2Object : KrollObject {
#endif
@private
...
extern NSString * weatherappweek2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	weatherappweek2Object *_weatherappweek2;
    KrollObject* console;
	BOOL shutdown;
