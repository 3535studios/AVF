...
// in simulator we redefine to format for weatherappweek2 Developer console
...
{\
	NSString * exceptionName = [@"org.weatherappweek2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.weatherappweek2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIweatherappweek2NativeItemNone = -1, 
	UIweatherappweek2NativeItemSpinner = -2,
	UIweatherappweek2NativeItemProgressBar = -3,
	
	UIweatherappweek2NativeItemSlider = -4,
	UIweatherappweek2NativeItemSwitch = -5,
	UIweatherappweek2NativeItemMultiButton = -6,
	UIweatherappweek2NativeItemSegmented = -7,
	
	UIweatherappweek2NativeItemTextView = -8,
	UIweatherappweek2NativeItemTextField = -9,
	UIweatherappweek2NativeItemSearchBar = -10,
	
	UIweatherappweek2NativeItemPicker = -11,
	UIweatherappweek2NativeItemDatePicker = -12,
	
	UIweatherappweek2NativeItemInfoLight = -13,
	UIweatherappweek2NativeItemInfoDark = -14,
	
	UIweatherappweek2NativeItemDisclosure = -15,
	
	UIweatherappweek2NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all weatherappweek2 instances of
