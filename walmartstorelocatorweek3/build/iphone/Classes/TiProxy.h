...
//Rare exceptions to indicate a bug in the _walmartstorelocatorweek3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for walmartstorelocatorweek3 proxies.
 */
