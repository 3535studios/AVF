 ...
 * to send analytic data that can be viewed on the walmartstorelocatorweek3 Dashboard.
 *
 * For information on getting started with walmartstorelocatorweek3 Platform Services,
