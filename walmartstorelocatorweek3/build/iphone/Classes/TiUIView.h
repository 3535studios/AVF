...
/**
 Base class for all walmartstorelocatorweek3 views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the walmartstorelocatorweek3 view hierarchy (such as wrapped iOS UIViews) was touched.
