...
// in simulator we redefine to format for walmartstorelocatorweek3 Developer console
...
{\
	NSString * exceptionName = [@"org.walmartstorelocatorweek3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.walmartstorelocatorweek3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIwalmartstorelocatorweek3NativeItemNone = -1, 
	UIwalmartstorelocatorweek3NativeItemSpinner = -2,
	UIwalmartstorelocatorweek3NativeItemProgressBar = -3,
	
	UIwalmartstorelocatorweek3NativeItemSlider = -4,
	UIwalmartstorelocatorweek3NativeItemSwitch = -5,
	UIwalmartstorelocatorweek3NativeItemMultiButton = -6,
	UIwalmartstorelocatorweek3NativeItemSegmented = -7,
	
	UIwalmartstorelocatorweek3NativeItemTextView = -8,
	UIwalmartstorelocatorweek3NativeItemTextField = -9,
	UIwalmartstorelocatorweek3NativeItemSearchBar = -10,
	
	UIwalmartstorelocatorweek3NativeItemPicker = -11,
	UIwalmartstorelocatorweek3NativeItemDatePicker = -12,
	
	UIwalmartstorelocatorweek3NativeItemInfoLight = -13,
	UIwalmartstorelocatorweek3NativeItemInfoDark = -14,
	
	UIwalmartstorelocatorweek3NativeItemDisclosure = -15,
	
	UIwalmartstorelocatorweek3NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all walmartstorelocatorweek3 instances of
