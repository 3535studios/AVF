...
@interface walmartstorelocatorweek3Object : KrollCoverageObject {
#else
@interface walmartstorelocatorweek3Object : KrollObject {
#endif
@private
...
extern NSString * walmartstorelocatorweek3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	walmartstorelocatorweek3Object *_walmartstorelocatorweek3;
    KrollObject* console;
	BOOL shutdown;
